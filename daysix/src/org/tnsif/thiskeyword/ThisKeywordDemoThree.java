...
public class ThisKeywordDemoThree {
	...
	void display()
	{
		/*when you call any parameterized method inside non-parameterized method then, 
		 * we get an error, to overcome then we have to use this keyword as an argument
		 * in method call */
		print(this);
	}
